...
public class SweetGen implements com.ruthika.gifts.sweets.Generator<Sweet>, Iterable<Sweet> {
    ...
    private Sweet[] instances = {new fivestar(), new Rasmalai(),
            new kova(), new Cashew()   };
    public Sweet next() {
        try {
